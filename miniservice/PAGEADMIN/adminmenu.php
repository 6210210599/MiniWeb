...
<body>
    <nav>
        <ul class="menu">
            ...
            <li class="item"><a href="show_cus.php">ข้อมูลลูกค้า</a></li>
            <li class="item"><a href="show_emp.php">ข้อมูลพนักงาน</a></li>
            <!--
            <li class="item"><a href="showcustomer.php">ข้อมูลลูกค้า</a></li>-->
