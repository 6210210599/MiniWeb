...
<form name="frmSearch" method="post" action="index.php">
    ...
    <tr>
        <th>ค้นหา</th>
        <th><input name="txtkeyword" type="text" id="txtkeyword" value="<?php echo $srtkeyword;?>" placeholder="รหัสงาน / รหัสลูกค้า / ชื่อ - สกุล"></th>
